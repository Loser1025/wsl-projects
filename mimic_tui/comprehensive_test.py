...
import sys
import os
from mimic_tui.agent import OpenRouterAgent
...
def test_basic_agent_creation():
    ...
    try:
        ...
        print(f"✓ Agent has {len(agent._tool_registry._tools)} tools registered")
...
def test_role_agents():
    ...
    try:
        from mimic_tui.config import AccountRotator
